...
KCT_ThirdPersonController = {}

KCT_ThirdPersonController.kGroundingDot = 0.9
...
function KCT_ThirdPersonController:Start()
...
function KCT_ThirdPersonController:Tick(deltaTime)
...
function KCT_ThirdPersonController:UpdateInput(deltaTime)
...
function KCT_ThirdPersonController:UpdateJump(deltaTime)
...
function KCT_ThirdPersonController:UpdateDrag(deltaTime)
...
function KCT_ThirdPersonController:UpdateMovement(deltaTime)
...
function KCT_ThirdPersonController:UpdateGrounding(deltaTime)
...
function KCT_ThirdPersonController:UpdateCamera(deltaTime)
...
function KCT_ThirdPersonController:UpdateMesh(deltaTime)
...
function KCT_ThirdPersonController:Move(velocity, deltaTime, vertSlideNormalLimit)
...
function KCT_ThirdPersonController:Jump()
...
function KCT_ThirdPersonController:SetGrounded(grounded)
...
function KCT_ThirdPersonController:GetCameraYaw()
